...
g++ -std=c++17 wheelchair.cpp left_right.cpp path_planning/DijkstraShortestPathAlg.cpp path_planning/Graph.cpp connection/arduino_serial.c steer.cpp -lrealsense2 -o wheelchair
